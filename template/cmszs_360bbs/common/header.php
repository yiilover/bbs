...
<body id="nv_{$_G[basescript]}" class="pg_{CURMODULE}{if $_G['basescript'] === 'portal' && CURMODULE === 'list' && !empty($cat)} {$cat['bodycss']}{/if}" onkeydown="if(event.keyCode==27) return false;">
	...
	<!--{if empty($topic) || $topic['useheader']}-->
		...
		<div id="nv">
        <div class="header">
        <h2><a href="./" class="logo">$_G['style']['boardlogo']</a></h2>
                    ...
                    <!--{if $_G['uid']}-->
                    <a class="message-hd <!--{if empty($_G['cookie']['ignore_notice']) && ($_G[member][newpm] || $_G[member][newprompt_num][follower] || $_G[member][newprompt_num][follow] || $_G[member][newprompt])}--> newmessage-hd <!--{/if}-->" href="<!--{if $_G[member][newprompt]}-->home.php?mod=space&do=notice<!--{else}-->home.php?mod=space&amp;do=pm<!--{/if}-->" target="_blank"></a>
                    	<div id="qmenuuu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenuuu','pos':'34!','ctrlclass':'a','duration':2});showForummenu($_G[fid]);})">
                        <div class="avtav radius5 self-info">
                    ...
                    <a href="member.php?mod=logging&amp;action=login&amp;referer=" id="qmenu" onClick="showWindow('login', this.href);return false;">{lang login}</a>
