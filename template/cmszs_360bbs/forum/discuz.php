...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if}">
	<!--{if empty($gid)}-->
		<div id="chart" class="bm bw0 cl  radius5">
			<p class="chart z">{lang index_today}: <em>$todayposts</em><span class="pipe">|</span>{lang index_yesterday}: <em>$postdata[0]</em><span class="pipe">|</span>{lang index_posts}: <em>$posts</em><span class="pipe">|</span>{lang index_members}: <em>$_G['cache']['userstats']['totalmembers']</em></p>
			<div class="quick-thread-box cl">
<study_addnew><a onclick="showWindow('nav','forum.php?mod=misc&amp;action=nav')" title="$cmszs_lang[2]" style="cursor:pointer;" data-text="$cmszs_lang[2]" class="quick-thread btn-base" target="_blank">$cmszs_lang[3]</a></study_addnew>
</div>
	...
	<div class="z">
     ...
     <div class="quick-thread-box cl" style="margin-bottom:20px;">
<study_addnew><a onclick="showWindow('nav','forum.php?mod=misc&amp;action=nav')" title="$cmszs_lang[2]" style="cursor:pointer;" data-text="$cmszs_lang[2]" class="quick-thread btn-base" target="_blank">$cmszs_lang[3]</a></study_addnew>
</div>
<div style="clear:both;">
	...
	<div class="mn">
		...
		<!-- index four grid -->
		<div class="fl bm noborder block-list radius5">
			<div class="bm bmw cl">
		...
		<div class="fl bm noborder block-list radius5">
			...
			<div class="bm bmw {if $forumcolumns} flg{/if} cl grep15">
		...
		<!--{if empty($gid) && $_G['setting']['whosonlinestatus']}-->
			<div id="online" class="bm oll noborder block-list radius5">
				<div class="bm_h noborder radius5 block-item">
				<!--{if $detailstatus}-->
		...
		<div class="bm lk  noborder block-list radius5">
